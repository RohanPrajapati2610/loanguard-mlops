...
NEW_PATH     = os.path.join(BASE_DIR, "data/processed/new_data.csv")
DRIFTED_PATH = os.path.join(BASE_DIR, "data/drifted/drifted_data.csv")
...
@st.cache_data
def load_drifted():
    return pd.read_csv(DRIFTED_PATH)
